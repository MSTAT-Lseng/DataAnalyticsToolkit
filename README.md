...
![QQ20260830-181728.png](https://files.seeusercontent.com/2026/08/30/h1Kw/QQ20260830-181728.png)
...
| 模块 | 能力 |
| --- | --- |
| 数据清洗 | 上传 CSV / XLS / XLSX；预览数据；按列删除空值、去重和过滤最小字数；导出清洗结果与统计信息 ![clean.png](https://files.seeusercontent.com/2026/08/30/F3yg/clean.png) |
| 分词统计 | 支持文本和表格列；中英文分词；内置或自定义停用词；自定义词典；高频词图表；导出完整词频表 ![fenci.png](https://files.seeusercontent.com/2026/08/30/Fe8h/fenci.png) |
| 词云制作 | 根据文本或词频表生成词云；支持最大词数、配色方案和背景色设置 ![wordcloud.png](https://files.seeusercontent.com/2026/08/30/u6Ey/wordcloud.png) |
| 情感分析 | 使用 SnowNLP 分析文本情感；支持逐句分析、表格列批量分析、自定义情感词微调和 Excel 导出 ![QQ20260830-182924.png](https://files.seeusercontent.com/2026/08/30/n8jT/QQ20260830-182924.png) |
| 社会网络关系图 | 根据文本或表格列统计词语共现；可导入分词统计导出的词频表作为分词规则；生成可交互关系图和关系明细 ![network.png](https://files.seeusercontent.com/2026/08/30/2zjT/network.png) |
| 回归分析 | 从表格中选择至少两列 1 到 10 的数值列；按选择顺序执行所有两两一元线性回归；展示散点图、回归线、方程、R² 和 MSE ![QQ20260830-184558.png](https://files.seeusercontent.com/2026/08/30/ezQ4/QQ20260830-184558.png) |
| 热力分析 | 选择至少两列 1 到 10 的数值列；计算 Pearson 相关系数矩阵；使用 Plotly 绘制带数值标注的热力图 ![QQ20260830-184619.png](https://files.seeusercontent.com/2026/08/30/Ht4l/QQ20260830-184619.png) |
| 聚类分析 | 支持按句子或表格列聚类；使用 TF-IDF 提取文本特征和 K-Means 分组；展示聚类关键词、二维样本分布、中心距离和样本归属；支持导出 ![QQ20260830-184432.png](https://files.seeusercontent.com/2026/08/30/J4xy/QQ20260830-184432.png) |
